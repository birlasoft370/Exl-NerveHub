...
{
    public interface IAuthenticateServiceDummy
    {
        Task<AuthenticationResponse> IsLDAPUser(AuthenticationRequest authenticationRequest);

    }

    public class AuthenticateServiceDummy : IAuthenticateServiceDummy
    {
        ...
        public AuthenticateServiceDummy(IAuthenticationOperations authenticationOperations, IJwtTokenService jwtTokenHandler, IConfiguration configuration)
        {
