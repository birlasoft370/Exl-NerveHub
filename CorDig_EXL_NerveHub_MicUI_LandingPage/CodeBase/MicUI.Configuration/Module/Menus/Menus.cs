...
namespace MicUI.Configuration.Module.Menus
{
    public class Menus : IMenus
    {
        ...
        public NavMenuViewModel GetAllMenus()
        {
            ...
            var UserInfo = _getSessionValues.GetSessionUserInfo(); //_moduleMenusService.IsLADPUserAsync().Result;
            ...
            //Page Menus
            model.MenuViewModel = UserMenus.data.Where(itmeValue => ((itmeValue.sModuleName == "AppConfiguration" || itmeValue.URL == "")
