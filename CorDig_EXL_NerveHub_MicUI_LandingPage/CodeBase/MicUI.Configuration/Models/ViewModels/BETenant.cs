namespace MicUI.Configuration.Models.Security
{

    public class BETenantInfo
    {
        ...
        public string DatabaseConnectionBIQueryString { get; set; }
        public string DatabaseConnectionDBExceptionHandling { get; set; }
        ...
        public string ClientMultiLanguage { get; set; }
        public string DatabaseConnectionBIDatawareHouseString { get; set; }
