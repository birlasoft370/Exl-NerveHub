...
namespace BPA.EmailManagement.DataLayer.ExternalRef.Config
{
    public class DLLanguages : IDisposable
    {
        ...
        public void InsertUpdateData(BEMailTranslatorConfiguration oBEMailTranslatorConfiguration, int iFormID, BETenant oTenant)
        {
            try
            {
                ...
                db.AddInParameter(dbCommand, PARAM_Options, DbType.String, oBEMailTranslatorConfiguration.Options);// issue
